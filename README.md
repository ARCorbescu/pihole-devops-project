...
│   ├── inventory.tf              # Auto-generates Ansible inventory
│   ├── provider.tf               # AWS provider configuration
│   └── pihole_key                # SSH private key (generated)
│
├── ansible/                      # Configuration management
│   ├── playbook.yml              # Main deployment playbook
│   ├── vault.yml                 # Encrypted secrets (Pi-hole password)
│   ├── inventory.ini             # Auto-generated by Terraform
│   ├── group_vars/
│   │   └── all.yml               # Global variables
│   └── roles/                    # Modular Ansible roles
│       ├── pihole-system-setup/  # System dependencies (git, curl)
...
│   ├── docker-compose.yml        # Pi-hole + monitoring services
│   ├── Dockerfile.monitor-bash   # System resource monitor
│   └── Dockerfile.monitor-python # Pi-hole stats API
│
├── scripts/                      # Utility scripts
│   ├── pihole_stats.py           # Pi-hole statistics webhook
│   ├── update_ip.py              # Dynamic IP updater for Security Groups
│   ├── requirements.txt          # Python dependencies
│   └── system_monitor.sh         # Bash system monitor
│
└── docs/                         # Documentation
    ├── INSTALLATION.md           # Step-by-step installation guide
    ├── USAGE.md                  # How to use the deployed system
...
- ✅ **Modular Ansible roles** (single-responsibility design)
- ✅ **Ansible Vault** for secret management
- ✅ **Idempotent playbooks** (safe to re-run)
- ✅ **External role integration** (`geerlingguy.docker`)

### Pi-hole Deployment
- ✅ **Pi-hole v6** with custom configuration
- ✅ **Docker Compose** multi-service stack
- ✅ **System monitoring** (Bash + Python)
- ✅ **Webhook API** for statistics (port 5005)

### Automation & Utilities
- ✅ **Dynamic IP updater** (`scripts/update_ip.py`)
- ✅ **"Pull-First" deployment strategy** (prevents DNS errors)
- ✅ **Automatic DNS switchover** (systemd-resolved → Pi-hole)
